...
const liveTracks = [
  ...
  { trackId: "inferno", number: 2, title: "Inferno", src: "/elegialc-aovivo-sanguepodre/inferno.mp3", file: "inferno.mp3" },
  { trackId: "farol", number: 3, title: "Farol", src: "/elegialc-aovivo-sanguepodre/farol.mp3", file: "farol.mp3" },
  { trackId: "deixe-a-paz", number: 4, title: "Deixe A Paz", src: "/elegialc-aovivo-sanguepodre/deixe-a-paz.mp3", file: "deixe-a-paz.mp3" },
  { trackId: "contra-a-parede", number: 5, title: "Contra A Parede", src: "/elegialc-aovivo-sanguepodre/contra-a-parede.mp3", file: "contra-a-parede.mp3" },
  { trackId: "ancora", number: 6, title: "Âncora", src: "/elegialc-aovivo-sanguepodre/ancora.mp3", file: "ancora.mp3" },
];
...
const AoVivoSanguePodre = () => {
  ...
  return (
    <main className="page-gradient relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-5 py-28 md:px-10 md:py-36">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="relative mb-8">
              <img
                ...
                className="w-full max-w-sm rounded-xl border border-white/[0.1] shadow-[0_0_60px_rgba(220,38,38,0.2)]"
              />
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {liveTracks.map((track, index) => (
            <Card
              key={track.trackId}
              className={`glassmorphism lift-hover group border-white/[0.08] bg-zinc-950/60 fade-up animation-delay-${(index + 1) * 100}`}
            >
        ...
        <footer className="mt-20 text-center">
          <div className="slash-divider inline-block border-t border-white/[0.06] pt-8">
            <p className="text-[11px] uppercase tracking-[0.25em] text-zinc-600">
              Elegia L.C. · 2026 ·Todos os direitos reservados
            </p>
          </div>
        </footer>
      </div>
